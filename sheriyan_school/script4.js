// // dom document object manupulation html ke kisi v element ko select karke change karma
// //change karne ke poore process me 
// // Selection
...
// apple.style.border="2px solid black";
// apple.style.padding="10px";
// apple.style.borderRadius="5px";
// // html Change
// apple.innerHTML="Hello World";
// apple.innerText="Hello World";
// apple.textContent="Hello World";
// apple.innerHTML="Hello World";
// apple.innerHTML="<h1>Hello World</h1>";
...
// ek array hoga jisme object honge usme ek image hoga or ek name hoga
var arr = [
